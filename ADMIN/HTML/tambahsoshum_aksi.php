...
$sql = "INSERT INTO prodisoshum (kode_ptn, prodi_ptn, utbk, dayatampung_baru, peminat_lama, ratio, peminat_baru, rankrendah_pendaftar, rankrendah_peluang) 
        VALUES ('$kode','$prodi', '$utbk', '$tampung_baru', '$minat_lama', '$ratio', '$minat_baru', '$rankrendah_pendaftar', '$rankrendah_peluang')";

mysqli_query($db, $sql);

header("location:TambahProdiSoshum.php?pesan=input");
?>